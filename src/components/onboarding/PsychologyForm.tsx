  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        ...
        <CardDescription>
          Help us understand your personality and behavioral patterns for more
                    ...
                    <FormControl>
                      ...
                      >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <label
                            htmlFor="direct_confrontation"
                            className="text-sm"
                          >
                            I address conflicts directly and immediately
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                          ...
                          />
                          <label
                            htmlFor="passive_aggressive"
                            className="text-sm"
                          >
                            I tend to be passive-aggressive when upset
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="seeks_compromise"
                            id="seeks_compromise"
                          />
                          <label htmlFor="seeks_compromise" className="text-sm">
                            I look for compromises and middle ground
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="highly_expressive"
                            id="highly_expressive"
                          />
                          <label
                            htmlFor="highly_expressive"
                            className="text-sm"
                          >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="reserved" className="text-sm">
                            I&apos;m generally reserved and private
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                          ...
                          />
                          <label
                            htmlFor="selective_sharing"
                            className="text-sm"
                          >
                            I share emotions selectively with close people
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="emotional_walls"
                            id="emotional_walls"
                          />
                          <label htmlFor="emotional_walls" className="text-sm">
                            I have emotional walls and find it hard to open up
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="impulsive" className="text-sm">
                            I make decisions quickly based on gut feelings
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="analytical" id="analytical" />
                          <label htmlFor="analytical" className="text-sm">
                            I analyze all options thoroughly before deciding
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="seeks_validation"
                            id="seeks_validation"
                          />
                          <label htmlFor="seeks_validation" className="text-sm">
                            I seek input and validation from others
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                          ...
                          <label htmlFor="independent" className="text-sm">
                            I prefer making decisions independently
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="withdraws" className="text-sm">
                            I withdraw and need alone time
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="seeks_comfort"
                          />
                          <label htmlFor="seeks_comfort" className="text-sm">
                            I seek comfort and support from others
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="becomes_irritable"
                            id="becomes_irritable"
                          />
                          <label
                            htmlFor="becomes_irritable"
                            className="text-sm"
                          >
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="overthinks" className="text-sm">
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="secure" className="text-sm">
                            Secure - I&apos;m comfortable with intimacy and
                            independence
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="anxious" id="anxious" />
                          <label htmlFor="anxious" className="text-sm">
                            Anxious - I crave closeness but worry about
                            abandonment
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="avoidant" id="avoidant" />
                          <label htmlFor="avoidant" className="text-sm">
                            Avoidant - I value independence over closeness
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="disorganized"
                          />
                          <label htmlFor="disorganized" className="text-sm">
                            Disorganized - I have mixed feelings about closeness
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          />
                          <label
                            htmlFor="words_of_affirmation"
                            className="text-sm"
                          >
                            Words of Affirmation - I love hearing loving words
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="physical_touch"
                          />
                          <label htmlFor="physical_touch" className="text-sm">
                            Physical Touch - I express love through touch
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                          ...
                          <label htmlFor="quality_time" className="text-sm">
                            Quality Time - I value undivided attention
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                          ...
                          <label htmlFor="acts_of_service" className="text-sm">
                            Acts of Service - I appreciate helpful actions
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="gifts" id="gifts" />
                          <label htmlFor="gifts" className="text-sm">
                            Gifts - I love thoughtful gestures and presents
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          ...
                          <label htmlFor="very_open" className="text-sm">
                            Very open - I share easily and deeply
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="selective" id="selective" />
                          <label htmlFor="selective" className="text-sm">
                            Selective - I open up to people I trust
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem value="guarded" id="guarded" />
                          <label htmlFor="guarded" className="text-sm">
                            Guarded - I&apos;m cautious about sharing personal
                            things
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="extremely_private"
                            id="extremely_private"
                          />
                          <label
                            htmlFor="extremely_private"
                            className="text-sm"
                          >
                            Extremely private - I rarely share personal details
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                  ...
                  <FormItem>
                    ...
                    <FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="respects_authority"
                            id="respects_authority"
                          />
                          <label
                            htmlFor="respects_authority"
                            className="text-sm"
                          >
                            I generally respect and follow authority
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="questions_authority"
                            id="questions_authority"
                          />
                          <label
                            htmlFor="questions_authority"
                            className="text-sm"
                          >
                        ...
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="rebels_against_authority"
                            id="rebels_against_authority"
                          />
                          <label
                            htmlFor="rebels_against_authority"
                            className="text-sm"
                          >
                            I tend to rebel against authority figures
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
                      ...
                      >
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            ...
                            id="natural_leader"
                          />
                          <label htmlFor="natural_leader" className="text-sm">
                            Natural leader - I often take charge
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="prefers_following"
                            id="prefers_following"
                          />
                          <label
                            htmlFor="prefers_following"
                            className="text-sm"
                          >
                            Prefers following - I&apos;m comfortable being led
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="situational_leader"
                            id="situational_leader"
                          />
                          <label
                            htmlFor="situational_leader"
                            className="text-sm"
                          >
                            Situational leader - I lead when needed
                          </label>
                        </div>
                        <div className="flex items-center space-x-2">
                          <RadioGroupItem
                            value="avoids_responsibility"
                            id="avoids_responsibility"
                          />
                          <label
                            htmlFor="avoids_responsibility"
                            className="text-sm"
                          >
                            Avoids responsibility - I prefer not to lead
                          </label>
                        </div>
                      </RadioGroup>
                    </FormControl>
            ...
            <div className="space-y-6">
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel>
                      What are your emotional triggers? (Select all that apply)
                    </FormLabel>
                    <div className="grid grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={() => (
                  <FormItem>
                    <FormLabel>
                      What brings you comfort? (Select all that apply)
                    </FormLabel>
                    <div className="grid grid-cols-2 gap-4">
